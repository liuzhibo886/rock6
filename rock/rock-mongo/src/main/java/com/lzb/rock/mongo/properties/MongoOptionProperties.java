...
public class MongoOptionProperties {
	 ...
	 * 最小连接数
	 */
	private Integer minConnectionPerHost = 2;
	/**
	 * 最大连接数
	 */
	...
	/**
	 * 设置线程阻塞等待连接的最长时间，单位毫秒
	 */
	private Integer maxWaitTime = 1000 * 60 * 10;
	/**
	 * 设置池连接的最大空闲时间。最大空闲时间，以毫秒为单位，必须大于等于0，0表示寿命没有限制
	 */
	private Integer maxConnectionIdleTime = 1000 * 60 * 10;
	/**
	 * 设置池连接的最长生存时间，单位毫秒，小于等于0 为无限制
	 */
	private Integer maxConnectionLifeTime = 1000 * 60 * 60 * 8;

	/**
	 * 服务器查找超时时间
	 */
	private Integer serverSelectionTimeout = 1000 * 10;
	 ...
	 * 连接超时时间，毫秒
	 */
	private Integer socketTimeout = 1000 * 10;
	/**
	 * *设置是否使用SSL。
	 */
	...
	/**
	 * 设置心跳频率。这是驱动程序尝试确定中每个服务器的当前状态的频率，毫秒
	 */
	private Integer heartbeatFrequency = 1000 * 10;
	/**
	 * 心跳连接超时时间
	 */
	private Integer heartbeatConnectTimeout = 1000 * 20;
	/**
	 * 设置用于群集检测信号的连接的套接字超时
	 */
	private Integer heartbeatSocketTimeout = 1000 * 20;
	/**
	 * 可接受的延迟差（以毫秒为单位），必须大于等于0
	 * 
	 * @return{@code this}
	 */
