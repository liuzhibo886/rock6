...
public class UtilJson {
	...
	public static JSONObject getJsonObject(String jsonStr) {
		...
		if (obj instanceof JSONArray) {
			throw new BusException(RockEnum.JSON_ERR, "JSON字符串转换为JSONObject类型失败,原字符串为JSONArray类型");
		}
	...
	public static JSONArray getJsonArray(String jsonStr) {
		...
		if (obj instanceof JSONObject) {
			throw new BusException(RockEnum.JSON_ERR, "JSON字符串转换为JSONArray类型失败,原字符串为JSONObject类型");
		}
