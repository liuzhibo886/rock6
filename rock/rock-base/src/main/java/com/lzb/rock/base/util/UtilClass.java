...
public class UtilClass {
	...
	public static <T> List<T> getJavaListByString(String str, Class<T> clazz) {
		...
		throw new BusException(RockEnum.TYPE_ERR, "类型异常,只能转换list JSON 字符串" + clazz.getTypeName());
	}
...
//				return (T) obj.toJavaList(clazz);
				throw new BusException(RockEnum.TYPE_ERR, "类型异常,不能转换list类型;" + clazz.getTypeName());
			}
		}
		// 非JSON字符串
		if (!isJson) {
			...
			if (typeName.equals("int") || typeName.equals("java.lang.Integer")) {
				...
				throw new BusException(RockEnum.TYPE_ERR, "类型异常" + typeName);
			}
		}
		throw new BusException(RockEnum.TYPE_ERR, "类型异常" + clazz.getTypeName());
	}
